...
Write-Host "Starting the push to GitHub with out directory included..." -ForegroundColor Green
...
Write-Host "✓ Successfully pushed to GitHub with out directory included!" -ForegroundColor Green
