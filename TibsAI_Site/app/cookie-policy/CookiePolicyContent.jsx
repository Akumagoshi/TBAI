  ...
  return (
    <>
      <Hero 
        ...
        description="This Cookie Policy explains how Tiberius AI uses cookies and similar technologies to recognize you when you visit our website."
      ...
      <section className="py-16 bg-deep-blue">
        <div className="container mx-auto px-4">
          <div className="prose prose-invert prose-lg max-w-4xl mx-auto">
            <p>
              This Cookie Policy explains how Tiberius AI ("we", "us", or "our") uses cookies and similar technologies to recognize you when you visit our website. It explains what these technologies are and why we use them, as well as your rights to control our use of them.
            </p>
            ...
            <p>
              Cookies set by the website owner (in this case, Tiberius AI) are called "first-party cookies". Cookies set by parties other than the website owner are called "third-party cookies". Third-party cookies enable third-party features or functionality to be provided on or through the website (e.g. advertising, interactive content, and analytics). The parties that set these third-party cookies can recognize your computer both when it visits the website in question and also when it visits certain other websites.
            </p>
